module.exports = {
    ...
    async createSettingsFW(sn) {
        ...
        await this.createDataPoint(
            `${this.iob.namespace}.${sn}.settings.firmware_update_check_manuel`,
            common,
            "state",
            null,
            null,
    ...
    async ensureRemoteButtons(sn) {
        ...
        for (const [id, name] of buttons) {
            ...
            await this.createDataPoint(`${this.iob.namespace}.${sn}.remote.${id}`, common, "state", null, null, null);
        }
    },
    /**
     * @param {string} sn
    ...
    async ensureScheduleStates(sn) {
        ...
        for (const [key, label] of days) {
            ...
            await this.createDataPoint(
                `${this.iob.namespace}.${sn}.schedule.${key}`,
                common,
                "state",
                null,
                null,
            ...
            if (meta && (meta.modelClass === "S" || meta.modelClass === "X")) {
                ...
                await this.createDataPoint(
                    `${this.iob.namespace}.${sn}.schedule.${key}_2`,
                    common,
                    "state",
                    null,
                    null,
        ...
        await this.createDataPoint(`${this.iob.namespace}.${sn}.schedule.pause`, common, "state", null, null, null);
        ...
        await this.createDataPoint(
            `${this.iob.namespace}.${sn}.schedule.loadSchedule`,
            common,
            "state",
            null,
            null,
        ...
        await this.createDataPoint(`${this.iob.namespace}.${sn}.schedule.set`, common, "state", null, null, null);
