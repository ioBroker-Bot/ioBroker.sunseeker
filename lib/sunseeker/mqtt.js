...
module.exports = {
    ...
    onMqttMessage(topic, payload) {
        ...
        if (id === "getSupportCustomPatternSet") {
            this.getSupportCustomPattern(id, sn, topic, statusData, meta);
            return;
        }
     ...
     * @param {any} meta
     */
    getSupportCustomPattern(id, sn, topic, statusData, meta) {
        if (typeof statusData.support_custom_pattern === "object" && statusData.support_custom_pattern !== null) {
            ...
            statusData.support_custom_pattern = new_pattern;
            this.emit("mqtt", { sn, topic, data: statusData, id: id });
        }
    },
