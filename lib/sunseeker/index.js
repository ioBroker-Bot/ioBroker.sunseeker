...
class Sunseeker extends EventEmitter {
     ...
     * @param {{extendObject:Function}} [options.iobObjects]
     */
    constructor(username, password, options = {}) {
        ...
        if (options.iobTimers) {
            this.iobTimer = options.iobTimers;
        } else {
            throw new Error("Missing wrapper setTimout and setInterval!!!");
        }

        this.iobObject = options.iobObjects;
        this.session = null;
        this.devicesRaw = {};
        this.deviceMeta = {};
    ...
    stop() {
        ...
        if (this.sleepTimer) {
            this.iobTimer.clearTimeout(this.sleepTimer);
            this.sleepTimer = null;
        }
        ...
        if (this._pollFW) {
            this.iobTimer.clearInterval(this._pollFW);
            this._pollFW = null;
        }
